...
const atlassianOAuth2Client = await createOAuth2Client('atlassian', {
	clientId: env.ATLASSIAN_CLIENT_ID,
	clientSecret: env.ATLASSIAN_CLIENT_SECRET,
	redirectUri: env.ATLASSIAN_REDIRECT_URI
});

export const atlassianPlugin = new Elysia()
	.get(
		'/oauth2/atlassian/authorization',
